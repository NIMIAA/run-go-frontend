...
import { getDriverData, setDriverData, getDriverAuthToken, Driver, toggleDriverAvailability, updateDriverLocation } from "@/app/utils/driverAuth";
...
function DashboardContent() {
    ...
    useEffect(() => {
        ...
        console.log("Loaded driverData from localStorage:", driverData);
        if (driverData) {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <div>Dashboard loaded (loading state)</div>
    ...
    if (error) {
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <div>Dashboard loaded (error state)</div>
    ...
    if (!driver) {
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <div>Dashboard loaded (no driver data)</div>
